...
<ResearchItem topic = {'Trends in the IT Sector of Non-Profit Organizations'} description = {'What do NPO IT leaders say about IT investment over the past 17 years? Visualize CIO4Good survey trends.'} link={'/projects/cio4good'} image={cio4Good} buttonText={'View Project'}/>
